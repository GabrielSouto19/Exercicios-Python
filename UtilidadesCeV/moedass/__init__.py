...
def resumo(x,a=0,d=0):
    ...
    print('=-'*15)
    print(f'Preco analisado:{moeda(x):>10}R$')
    print(f'Dobro do preco: {dobro(x,True):>10}R$')
    print(f'Metade do preco:{metade(x,True):>10}R$')
    print(f'{a}% de aume =  {aumentar(x,a,True):>10}R$')
    print(f'{d}% de desc =  {diminuir(x,d,True):>10}R$')
    print('=-'*15)
